...
function About() {
  return (
    <div
      className={`bg-[url(/images/what.png)] max-sm:bg-[url(/images/aboutBGMobile.png)] h-[150vh] max-sm:h-[120vh] bg-cover bg-no-repeat -mt-7 w-full relative z-40`}
    >
      <div className="w-full h-full justify-center items-center flex flex-col">
        <div className="w-full justify-center items-center flex flex-col max-sm:px-8">
          <h1 className={`text-8xl ${imfell400.className} text-[#EAE5DA]`}>
            About us
          </h1>
        ...
        <div className="flex w-full max-sm:flex-col">
          <div className="w-1/2 max-sm:w-full max-sm:justify-center max-sm:flex">
            ...
            <img className="hidden max-sm:flex" src="/images/aboutCards2.png" alt="card" />
          </div>
          <div className="w-1/2 max-sm:w-full flex flex-col justify-center items-start max-sm:items-center gap-4">
            ...
            <div className="pr-40 max-sm:px-7 max-sm:text-center ">
              <p className={`text-[#C3AF93] ${imfell400.className} text-2xl max-sm:text-xl`}>
