...
function WhitePapper() {
  return (
    <div
      className={`bg-[url(/images/whitepaper.png)] max-sm:bg-[url(/images/whitepaperBGMobile.png)] max-sm:bg-center h-[120vh] max-sm:z-20 max-sm:-top-6  py-32 relative z-10 bg-cover bg-no-repeat -mt-10 w-full max-[400px]:h-full max-[400px]:-mt-16`}
    >
